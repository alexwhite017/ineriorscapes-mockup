...
import Image from "./assets/Art/50088409472_9a3261b9e8_b.jpeg";
import FloralImage1 from "./assets/Art/E77B09F1-442F-45F3-8501-75AD1C3002D9-1024x768.jpeg";
import FloralImage2 from "./assets/Art/912E3A3F-1CA3-4D08-BA7B-A5267C3DCFE6_1_105_c.jpeg";
import FloralImage3 from "./assets/Art/IMG_0941-1024x764.jpeg";
...
const Florals = () => {
    return (
        <div>
            ...
            <main>
                <Hero image={Image} color="bg-florals" text="Florals / Events"/>
                ...
                <section className="details">
                    ...
                    <div className=" bg-soft-green rounded-3xl p-10 max-w-3xl">
                        <img src={FloralImage1} alt="" className="rounded-3xl aspect-16/9 w-full m-auto object-cover" />
                    ...
                    <div className=" bg-walls rounded-3xl p-10 max-w-3xl">
                        <img src={FloralImage2} alt="" className="rounded-3xl aspect-16/9 w-full m-auto object-cover" />
                    ...
                    <div className=" bg-holiday rounded-3xl p-10 max-w-3xl">
                        <img src={FloralImage3} alt="" className="rounded-3xl aspect-16/9 w-full m-auto object-cover" />
