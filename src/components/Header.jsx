  ...
  const toggleMenu = () => {
    ...
    return (
        <div className=" flex justify-between items-center px-4 fixed top-0 left-0 right-0 bg-white z-100 shadow-md h-[77px]">
            <Link to="/home" className="" onClick={() => {window.scroll(0, 0);}}><img  className="w-7/10 md:w-full" src="src/assets/logo.svg" alt="" /></Link>
            ...
            <nav className="lg:block hidden">
              <ul className="flex items-center gap-10">
                <li><Link to="/Home" className="hover:text-gray-500" onClick={() => {window.scroll(0, 0);}}>Home</Link></li>
